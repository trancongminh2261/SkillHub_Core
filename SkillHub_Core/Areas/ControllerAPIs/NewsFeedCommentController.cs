...
namespace LMSCore.Areas.ControllerAPIs
{
    ...
    public class NewsFeedCommentController : BaseController
    {
        [HttpPost]
        [Route("")]
        public async Task<IActionResult> Insert([FromBody]NewsFeedCommentCreate model)
        {
        ...
        [HttpPut]
        [Route("")]
        public async Task<IActionResult> Update([FromBody]NewsFeedCommentUpdate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpGet]
        [Route("")]
        public async Task<IActionResult> GetAll([FromQuery] NewsFeedCommentSearch baseSearch)
        {
