...
namespace LMSCore.Areas.ControllerAPIs
{
    ...
    public class RollUpController : BaseController
    {
        ...
        public async Task<IActionResult> InsertOrUpdate([FromBody] RollUpCreate model)
        {
        ...
        [HttpGet]
        [Route("")]
        public async Task<IActionResult> GetAll([FromQuery] RollUpSearch baseSearch)
        {
        ...
        public async Task<IActionResult> GetRollUpStudent([FromQuery] RollUpSearch baseSearch)
        {
