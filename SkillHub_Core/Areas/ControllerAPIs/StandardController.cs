...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class StandardController : BaseController
    {
        ...
        [HttpPut]
        [Route("api/Standard")]
        public async Task<IActionResult> Update([FromBody] StandardUpdate model)
        {
        ...
        [HttpPost]
        [Route("api/Standard")]
        public async Task<IActionResult> Insert([FromBody] StandardCreate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpGet]
        [Route("api/Standard")]
        public async Task<IActionResult> GetAll([FromQuery] StandardSearch baseSearch)
        {
