...
namespace LMS_Project.Areas.ControllerAPIs
{
    ...
    public class DepartmentController : BaseController
    {
        ...
        public async Task<IActionResult> TreeViewDepartment()
        {
        ...
        [HttpGet]
        [Route("AllRoot")]
        public async Task<IActionResult> GetAllRoot([FromQuery] SearchOptions baseSearch)
        {
        ...
        [HttpPost]
        [Route("Root")]
        public async Task<IActionResult> InsertRoot([FromBody] RootDepartmentCreate model)
        {
        ...
        [HttpPost]
        [Route("")]
        public async Task<IActionResult> Insert([FromBody] DepartmentCreate model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPut]
        [Route("")]
        public async Task<IActionResult> Update([FromBody] DepartmentUpdate model)
        {
            if (ModelState.IsValid)
            {
                try
