...
namespace LMSCore.Areas.ControllerAPIs
{
    ...
    public class CertificateConfigController : BaseController
    {
        ...
        private CertificateConfigService domainService;
        public CertificateConfigController()
        {
            this.dbContext = new lmsDbContext();
            this.domainService = new CertificateConfigService(this.dbContext);
        }
        [HttpPost]
        [Route("")]
        ...
        public async Task<IActionResult> GetByClassId(int classId)
        {
            try
            {
                var data = await domainService.GetByClassId(classId);
                if (data == null)
                    return StatusCode((int)HttpStatusCode.NoContent);
                return StatusCode((int)HttpStatusCode.OK, new { message = "Thành công !", data = data });
            }
