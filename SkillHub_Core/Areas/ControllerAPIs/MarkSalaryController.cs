...
namespace LMSCore.Areas.ControllerAPIs
{
    ...
    public class MarkSalaryController : BaseController
    {
        ...
        public async Task<IActionResult> InsertOrUpdate([FromBody] MarkSalaryCreate model)
        {
        ...
        [HttpGet]
        [Route("")]
        public async Task<IActionResult> GetAll([FromQuery] MarkSalarySearch baseSearch)
        {
